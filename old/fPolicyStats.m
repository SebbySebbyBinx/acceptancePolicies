function [expectPDoubleSpend, expectTimeWaited] = fPolicyStats( matPolicy, lambda, alpha, arrDistOfInitAttLead, numIter )

    %%arrCDFofConfirm = fCDFofConfirm( lambda, alpha, policy, arrT )
